...
Какой репозиторий вам нужен и как исправить или перевести эти страницы

Документация открыта: любой может исправить ошибку, дописать пропущенное или добавить перевод.
Сначала выберите, куда писать
