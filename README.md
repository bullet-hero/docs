...
genre. Everything here is published on the game's website (https://bullethero.space/). The docs are
open so anyone can fix a mistake, fill a gap or add a translation.
