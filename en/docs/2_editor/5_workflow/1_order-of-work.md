...
> [!caution] Caution
> This is the stage where the level is actually designed, and the stage people skip. A skeleton that is not fun does not become fun with decoration on top - it becomes a decorated level that is not fun
...
> [!caution] Caution
> Autosave is configured in the settings but does not run yet. Save at every step
