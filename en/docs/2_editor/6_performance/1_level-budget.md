...
**The capacity hint.** On save, a level records how many objects its heaviest frame needed. That is a hint for the loader rather than a limit, and a generator recomputes it
